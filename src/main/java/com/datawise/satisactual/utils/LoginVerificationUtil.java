...
public class LoginVerificationUtil {
    ...
    public String loginStatusDesc(Integer loginAttemptCode) {
        ...
        switch (loginAttemptCode) {
            case (STATUS_SUCCESS): txt_login_fail_reason = "SUCCESS"; break;
            case (STATUS_LIC_EXPIRED): txt_login_fail_reason = "STATUS_LIC_EXPIRED"; break;
            case (STATUS_PWD_EXPIRED): txt_login_fail_reason = "STATUS_PWD_EXPIRED"; break;
            case (STATUS_FAILED_PWD_LIMIT): txt_login_fail_reason = "STATUS_FAILED_PWD_LIMIT"; break;
            case (STATUS_DISABLED): txt_login_fail_reason = "STATUS_DISABLED"; break;
            case (STATUS_RESERVED_3): txt_login_fail_reason = "STATUS_RESERVED_3"; break;
            case (STATUS_RESERVED_4): txt_login_fail_reason = "STATUS_RESERVED_4"; break;
            case (STATUS_OUTSIDE_LOGIN_WINDOW): txt_login_fail_reason = "STATUS_OUTSIDE_LOGIN_WINDOW"; break;
            case (STATUS_RESERVED_6): txt_login_fail_reason = "STATUS_RESERVED_6"; break;
            case (STATUS_FUNCTIONAL_ID): txt_login_fail_reason = "STATUS_FUNCTIONAL_ID"; break;
            case (STATUS_PROFILE_EXPIRED): txt_login_fail_reason = "STATUS_PROFILE_EXPIRED"; break;
            case (STATUS_ALREADY_LOGGED_IN): txt_login_fail_reason = "STATUS_ALREADY_LOGGED_IN"; break;
            case (STATUS_BLOCKED_IP): txt_login_fail_reason = "STATUS_BLOCKEDIP"; break;
            case (STATUS_NO_REC_FOUND): txt_login_fail_reason = "STATUS_NORECFOUND"; break;
            case (STATUS_INTERNAL_SERVER_ERROR): txt_login_fail_reason = "INTERNAL_SERVER_ERROR"; break;
            default: txt_login_fail_reason = loginAttemptCode.toString(); break;
        }
